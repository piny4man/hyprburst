...
- Single-click app launching in the Rio-backed and native window frontends.

### Fixed

- Wait for Hyprland dispatch submission before Rio tears down the launcher PTY,
  preventing intermittent failures to open the selected app.
